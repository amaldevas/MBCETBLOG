              ...
              <div class="menu_section">
                ...
                <ul class="nav side-menu">
                  ...
                  <li><a><i class="fa fa-user"></i> Faculty <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      <li><a href="<?php echo base_url();?>index.php/user/faculty-add">Add Faculty</a></li>
                      <li><a href="<?php echo base_url();?>index.php/user/faculty-list">View Faculty</a></li>
                      <li><a href="<?php echo base_url();?>index.php/user/faculty-list">Edit Faculty</a></li>
                      <li><a href="<?php echo base_url();?>index.php/user/faculty-list"> Delete Faculty</a></li>
                    </ul>
                  </li>
